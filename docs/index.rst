.. PHASEfilter documentation master file, created by
   sphinx-quickstart on Sun Nov 30 09:25:25 2018.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.


***********************************
Welcome to PHASEfilter's documentation!
***********************************
...
* filter SNPs ans INDELs;
* choose best alginment tool, on the fly, to align two phased reference genomes;
